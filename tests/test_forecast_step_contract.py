...
def _checkpoint(tmp_path, step=360, manifest_step=None):
    ...
    schema={"format":"climate_diffusion.fixed_step_state.v1" if step==360 else "climate_diffusion.monthly_state.v1","forecast_step_hours":step,"variables":[{"name":"msl","dims":["lat","lon"],"shape":[1,2],"slice":[0,2],"coords":{"lat":[30.0],"lon":[120.0,140.0]},"attrs":{}}]}
